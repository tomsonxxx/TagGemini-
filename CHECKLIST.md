# ✅ Phonic Carbon — System Zarządzania Biblioteką DJ-ską
...
- [ ] Integrated Pro Player (z kontrolą decków).
- [ ] Camelot Interactive Wheel (wizualny selektor kluczy).

## 🤖 AI & INTEGRACJA
- [ ] **Gemini Tagger v2** — kontekstowe uzupełnianie brakujących okładek i opisów.
- [ ] **Semantic Search** — wyszukiwanie utworów po opisie nastroju.
- [ ] **Smart Smartlists** — dynamiczne playlisty oparte na parametrach audio.

## 📦 DYSTRYBUCJA I INFRASTRUKTURA
- [x] Środowisko AI Studio Applet.
- [x] Konfiguracja Next.js (Standalone).
- [ ] Produkcyjna baza danych.

---
*Checklista zaktualizowana na podstawie analizy Dokumentacji v2 + ChatGPT Archive.*
